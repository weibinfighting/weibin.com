...
&emsp;&emsp;Fisher的推理为：引进一个假设$H$:该女士并无鉴别能力。
...
&emsp;&emsp;我们可以设一个检验以了解第一类、第二类错误概率的关系。设拒绝域$W=\{\overline{x}\leq{c}\},\overline{x}\sim{N}(\theta,\sigma^2)$，则可以算出该检验的势函数
...
&emsp;&emsp;根据上述公式，我们发现有些的第二类错误并不容易算出来。
